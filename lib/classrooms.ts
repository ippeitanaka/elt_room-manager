...
export type TimeSlot = "1限目" | "2限目" | "昼食" | "3限目" | "4限目" | "5限目" | "6限目" | "マイスタ（午前）" | "マイスタ（午後）" | "補習（午前）" | "補習（午後）" | "再試験"
...
export interface DailyClassroomData {
  ...
  "マイスタ（午前）": Record<string, string | null>
  "マイスタ（午後）": Record<string, string | null>
...
export const regularTimeSlots: TimeSlot[] = ["1限目", "2限目", "昼食", "3限目", "4限目", "マイスタ（午前）", "マイスタ（午後）", "補習（午前）", "補習（午後）", "再試験"]
export const nursingTimeSlots: TimeSlot[] = ["5限目", "6限目", "マイスタ（午前）", "マイスタ（午後）", "補習（午前）", "補習（午後）", "再試験"]

// 有効な時限の配列（チェック制約と一致）
export const VALID_TIME_SLOTS: TimeSlot[] = ["1限目", "2限目", "昼食", "3限目", "4限目", "5限目", "6限目", "マイスタ（午前）", "マイスタ（午後）", "補習（午前）", "補習（午後）", "再試験"]
